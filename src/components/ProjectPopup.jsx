...
const ProjectPopup = ({ isOpen, onClose, projects }) => {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className={`relative w-full max-w-xl rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 ${
        ...
        <div className="p-4">
          <div className="space-y-4">
            ...
            <a
              ...
              className={`w-full inline-flex justify-center items-center px-6 py-3 rounded-lg font-semibold text-sm transition-all duration-200 transform hover:-translate-y-0.5 ${
                theme === "dark"
